<template>
    <div class="world_page">
        ...
        <div class="game_zone">
            ...
            <img src='/world2/castle1.png' alt="world 2 castle 1" id="w2-castle1" class="castles" @click="movePlayer('w2-castle1')">
            <img src='/world2/castle2.png' alt="world 2 castle 2" id="w2-castle2" class="castles" @click="movePlayer('w2-castle2')">
            <img src='/world2/castle3.png' alt="world 2 castle 3" id="w2-castle3" class="castles" @click="movePlayer('w2-castle3')">
